...
import { TimezoneSettingsContainer } from './timezone-settings-container';
import { ContextSettingsContainer } from './context-settings-container';
  ...
  return (
    <div className={'flex w-full flex-col space-y-4 pb-32'}>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            <Trans i18nKey={'account:timezone'} />
          </CardTitle>

          <CardDescription>
            <Trans i18nKey={'account:timezoneDescription'} />
          </CardDescription>
        </CardHeader>

        <CardContent>
          <TimezoneSettingsContainer userId={props.userId} />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            <Trans i18nKey={'account:context'} />
          </CardTitle>

          <CardDescription>
            <Trans i18nKey={'account:contextDescription'} />
          </CardDescription>
        </CardHeader>

        <CardContent>
          <ContextSettingsContainer userId={props.userId} />
        </CardContent>
      </Card>
